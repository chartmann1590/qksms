...
class RestoreBackupService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_START = "com.charles.messenger.ACTION_START"
        private const val ACTION_STOP = "com.charles.messenger.ACTION_STOP"
        private const val EXTRA_FILE_PATH = "com.charles.messenger.EXTRA_FILE_PATH"
