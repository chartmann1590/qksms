...
import com.charles.messenger.common.util.MessageDetailsFormatter
...
import com.charles.messenger.interactor.AddScheduledMessage
import com.charles.messenger.interactor.CancelDelayedMessage
...
import com.charles.messenger.model.Attachments
                ...
                .map { conv ->
                    ...
                    try {
                        ...
                        recentMessages.forEachIndexed { index, msg ->
                            Timber.d("ComposeViewModel: Message $index: isMe=${msg.isMe()}, body='${msg.body.take(50)}...'")
                        }
