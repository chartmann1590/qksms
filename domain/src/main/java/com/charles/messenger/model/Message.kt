...
open class Message : RealmObject() {
    ...
    // The MMS-messenger content provider returns messages where duplicate ids can exist. This is because
    // messenger and MMS are stored in separate tables. We can't use these ids as our realm message id
