...
if (video) {
    ...
    const handleScroll = () => {
        ...
        if (isVisible && !isPlaying) {
            // Video is visible, but don't autoplay (let user control)
        }
    };
...
// Console message
console.log('%cTextPilot AI Messaging', 'font-size: 24px; font-weight: bold; color: #2196F3;');
console.log('%cBeautiful SMS & MMS messaging with AI', 'font-size: 14px; color: #757575;');
console.log('%cVisit https://github.com/chartmann1590/textpilot', 'font-size: 12px; color: #9E9E9E;');
