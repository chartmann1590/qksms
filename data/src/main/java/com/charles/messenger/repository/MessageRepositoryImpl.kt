...
import com.charles.messenger.common.util.extensions.now
import com.charles.messenger.compat.TelephonyCompat
import com.charles.messenger.extensions.anyOf
...
import com.charles.messenger.util.ImageUtils
...
class MessageRepositoryImpl @Inject constructor(
    ...
    override fun savePart(id: Long): File? {
        ...
        val dir = File(Environment.getExternalStorageDirectory(), "SMS/Media").apply { mkdirs() }
    ...
    override fun sendMessage(
        ...
        // We only care about stripping messenger
        ...
        if (addresses.size == 1 && attachments.isEmpty() && !forceMms) { // messenger
